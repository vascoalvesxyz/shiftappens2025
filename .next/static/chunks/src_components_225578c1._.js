...
"[project]/src/components/three/OfficeDrawer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MyModel(props) {
    ...
    const { scene, camera, gl } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])();
    const { scene: modelScene } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"])("/models/office_file_cabinet.glb");
    const drawers = [];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyModel.useEffect": ()=>{
            if (!modelScene) return;
            modelScene.traverse({
                "MyModel.useEffect": (child)=>{
            ...
            const handleClick = {
                "MyModel.useEffect.handleClick": (event)=>{
                    ...
                    if (intersects.length > 0) {
                        const target = drawers.find({
                            "MyModel.useEffect.handleClick.target": (d)=>intersects[0].object.name.includes(d.name)
                        }["MyModel.useEffect.handleClick.target"]);
                        if (target) {
                            const isOpen = target.position.y < -0.1;
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(target.position, {
                                y: isOpen ? 0 : -0.2,
                                duration: 0.6,
                                ease: "power2.inOut"
                            });
            ...
            }["MyModel.useEffect.handleClick"];
            gl.domElement.addEventListener("click", handleClick);
            return ({
                "MyModel.useEffect": ()=>gl.domElement.removeEventListener("click", handleClick)
            })["MyModel.useEffect"];
        }
    }["MyModel.useEffect"], [
        modelScene,
...
_s(MyModel, "5T38Rn+4ZDHzbE76M5x5Oxy3vCk=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$OfficeDrawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/OfficeDrawer.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ThreeScene() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$react$2d$three$2d$fiber$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Canvas"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$OfficeDrawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                position: [
                    0,
                    0,
                    0
...
//# sourceMappingURL=src_components_225578c1._.js.map